...
def main():
    ...
    general_group.add_argument("-j", "--job", type=str, default=None, help="Job directory for temporary files [None]")
    ...
    general_group.add_argument("--no-auto", action="store_true", help="Automatically estimate k-mer size and related parameters [False]")
    general_group.add_argument("--debug", action="store_true", help="Output debug info and keep temporary files [False]")
